...
app.layout = html.Div(children=[
    ...
    # add a dropdown list to select values from column 'Launch Site'
    html.Div(children=[
...
def update_pie_chart(selected_site):
  if selected_site == 'ALL':
    ...
    fig = px.pie(filtered_df, names='class',
                 title=f'Success Rate of {selected_site}', labels={'class': 'Success'},
...
def update_scatter_chart(selected_site, payload_range):
  ...
  if selected_site == 'ALL':
    ...
    fig = px.scatter(
      filtered_df[filtered_df['Launch Site'] == selected_site], x='Payload Mass (kg)', y='class', color='Booster Version Category',
      color_continuous_scale=px.colors.sequential.RdBu,
